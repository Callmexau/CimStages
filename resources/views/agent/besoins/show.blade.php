            ...
            <div class="col-md-10">
                <div class="card card-outline card-success shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        {{-- Sections identiques à la page DARH --}}
                        <div class="card card-success card-outline mb-3">
                            ...
                            <div class="card-body row">
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="date" class="form-control form-control-sm" value="{{ $besoin->date_requete }}" readonly>
                                </div>
                            </div>
                        </div>
                    ...
                    {{-- Footer boutons avec actions agent --}}
                    <div class="card-footer text-right border-top bg-light d-flex justify-content-between">
                        <a href="{{ route('agent.besoins.index') }}" class="btn btn-secondary px-4">
                            <i class="fas fa-arrow-left"></i> Retour
                        </a>

                        @if($besoin->statut != 'valide')
                            <div class="btn-group">
                                <form action="{{ route('agent.besoins.transfer', $besoin->id) }}" method="POST" class="d-inline">
                                    @csrf
                                ...
                                <form action="{{ route('agent.besoins.rejeter', $besoin->id) }}" method="POST" class="d-inline">
                                    @csrf
                                    <button class="btn btn-outline-danger px-4" onclick="return confirm('Confirmer le rejet ?')">
